...
const WatchesCard = () => {
    ...
    const handleFilter = (subcategory) => {
        if (subcategory === "all") {
            setFilteredWatches(data.filter((item) => item?.category === "watches"))
        }
        else {
                            ...
                            >
                                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                                    ...
                                    <div className='md:hidden flex flex-col gap-4 justify-center items-center cursor-pointer'>
                                        ...
                                        <div onClick={() => handleFilter("MVMT")}>
                                            <h4 className='font-medium text-xl'>
                                                MVMT
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("Curren")}>
                                            <h4 className='font-medium text-xl'>
                                                Curren
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("DANIEL KLEIN")}>
                                            <h4 className='font-medium text-xl'>
                                                DANIEL KLEIN
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("VAN HEUSEN")}>
                                            <h4 className='font-medium text-xl'>
                                                VAN HEUSEN
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("WROGN")} >
                                            <h4 className='font-medium text-xl'>
                                                WROGN
                                            </h4>
                                        </div>
                                    ...
                                    filteredWatches.map((item, id) =>
                                        <div key={id}>
                                            ...
                                            <Card className="relative w-80 md:w-64 mx-auto hover:scale-105 cursor-pointer transition-all duration-300 delay-200 ease-in-out" >
                                                ...
                                                <div className='absolute left-1 z-[41] top-6 bg-red-800 px-1  text-white'>
                                                    <Typography className='text-xs md:text-sm'>{item?.brand}</Typography>
                                                </div>
