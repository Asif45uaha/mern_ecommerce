...
export default function GroceryCard() {
    ...
    const [filteredGroceries, setFilteredGroceries] = useState(data)
    ...
    const handleFilter = (subcategory) => {
        if (subcategory === "all") {
            setFilteredGroceries(data.filter((item) => item?.category === "groceries"))
        }
        else {
            const groceries = data.filter((item) => item?.subcategory === subcategory)
            setFilteredGroceries(groceries)
        }
    }
    return (
            ...
            <div>
                            ...
                            >
                                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                                    ...
                                    <div className='md:hidden flex flex-col gap-4 justify-center items-center cursor-pointer'>
                                        ...
                                        <div onClick={() => handleFilter("chocolates")}>
                                            <h4 className='font-medium text-xl'>
                                                Chocolates
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("dryfruits")}>
                                            <h4 className='font-medium text-xl'>
                                                Dry Fruits
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("powder")}>
                                            <h4 className='font-medium text-xl'>
                                                Powder
                                            </h4>
                                        </div>
                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900">Groceries</h1>
