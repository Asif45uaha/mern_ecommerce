...
const MobileCard = () => {
    ...
    const [filteredMobiles, setFilteredMobiles] = useState(data)
    ...
    const handleFilter = (subcategory) => {
        if (subcategory === "all") {
            setFilteredMobiles(data.filter((item) => item?.category === "mobiles"))
        }
        else {
            const laptops = data.filter((item) => item?.subcategory === subcategory)
            setFilteredMobiles(laptops)
        }
    }
    return (
                            ...
                            >
                                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                                    ...
                                    <div className='md:hidden flex flex-col gap-4 justify-center items-center cursor-pointer'>
                                        ...
                                        <div onClick={() => handleFilter("SAMSUNG")}>
                                            <h4 className='font-medium text-xl'>
                                                Samsung
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("VIVO")}>
                                            <h4 className='font-medium text-xl'>
                                                Vivo
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("REDMI")}>
                                            <h4 className='font-medium text-xl'>
                                                RedMi
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("POCO")}>
                                            <h4 className='font-medium text-xl'>
                                                Poco
                                            </h4>
                                        </div>
                                        ...
                                        <div onClick={() => handleFilter("OnePlus")}>
                                            <h4 className='font-medium text-xl'>
                                                OnePlus
                                            </h4>
                                        </div>
                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            {/* Filters */}
                            <div className='hidden md:flex flex-col gap-2 font-bold justify-start cursor-pointer'>
                                <h3 className='font-bold text-2xl'>Filter By Brands</h3>
                                <hr className='bg-gray-700' />
                                <div onClick={() => handleFilter("all")}>
