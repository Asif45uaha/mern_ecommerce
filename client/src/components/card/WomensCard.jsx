...
const WomensCard = () => {
    ...
    const [filteredWomens, setFilteredWomens] = useState(data)
    const navigate = useNavigate()
    const dispatch = useDispatch();
    useEffect(() => {
        const womens = data?.filter((item) => item?.category === "womens")
                            ...
                            >
                                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                                    ...
                                    <div className='md:hidden flex flex-col gap-4 justify-center items-center cursor-pointer'>
                                        ...
                                        <div onClick={() => handleFilter("sarees")}>
                                            <h4 className='font-medium text-xl'>
                                                Sarees
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("shorts")}>
                                            <h4 className='font-medium text-xl'>
                                                Shorts
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("blouses")}>
                                            <h4 className='font-medium text-xl'>
                                                Blouses
                                            </h4>
                                        </div>
                                        <div onClick={() => handleFilter("plazos")}>
                                            <h4 className='font-medium text-xl'>
                                                Plazos
                                            </h4>
                                        </div>
