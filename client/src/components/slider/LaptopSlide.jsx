...
const LaptopSlide = () => {
    ...
    useEffect(() => {
        const fetchLaptops = () => {
            const filteredLaptops = data.filter((lap) => lap?.category === "laptops")
    ...
    return (
        ...
        <div className="flex flex-col justify-center py-2  mx-auto w-full">
            <div>
                <Typography className="text-center text-xl md:text-2xl font-Poppins md:text-start py-2 font-bold md:ml-16">Best Of Laptops</Typography>
            </div>
            <div className="flex flex-row justify-center relative">
                ...
                <div id={"slider" + 1} className="flex flex-row overflow-x-scroll relative gap-4 py-2 px-4">
                    {laptops?.map((item, id) =>
